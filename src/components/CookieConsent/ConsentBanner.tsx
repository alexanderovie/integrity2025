...
const ConsentBanner = (): React.ReactElement | null => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-secondary text-white px-6 py-4 shadow-lg">
      <div className="container flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="bg-primary hover:bg-deep-blue px-4 py-2 text-sm rounded-sm"
          >
            Accept
          </button>
        </div>
