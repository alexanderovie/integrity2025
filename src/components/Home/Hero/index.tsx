  ...
  return (
    <section>
      <div className="relative pt-24 lg:pt-32 overflow-hidden">
        <div className="hero-visual relative h-full flex justify-center items-center bg-secondary lg:bg-[url('/images/home/banner/banner-img.jpg')] bg-cover bg-no-repeat bg-center">
